...
export default function SiteHeader(){
  return <header className="site-header">
    <div className="nav-shell">
      <a href="/" className="brand" aria-label="HexaRoot Ventures home"><Image className="brand-logo" src="/hexaroot-logo.webp?v=3" alt="HexaRoot Ventures" width={170} height={58} priority /></a>
      <nav>
